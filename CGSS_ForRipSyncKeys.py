...
facial_dic = {1: 'あ', 2: 'い', 3: 'う', 4: 'え', 5: 'お', 7: 'にやり', 8: 'ワ', 10: 'ワ'}
eye_l_dict = {10: 'ウィンク２', 11: 'ウィンク', 2: 'ウィンク'}
eye_r_dict = {10: 'ウィンク２右', 11: 'ウィンク右', 2: 'ウィンク右'}
...
#注释掉的是口型的另一储存位置的处理代码，结果不是很理想所以注释掉了，也许哪天兴致来了会处理
...
#眼部数据储存位置
eyesync = b["facial1Set"]["eyeKeys"]["thisList"]
recorder = {}
