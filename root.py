...
with open(os.path.basename(input_json)+".txt", "w",encoding='utf-8') as outfile:
    ...
    outfile.write('boneframe_ct:,'+str(len(time_x)-1)+'\n')
    ...
    while (i < len(time_x)):
        outfile.write('センター,'+str(i-1)+','+str(-(array_x[i])*12)+',0.0,'+str(-(array_z[i])*12)+',0.0,0.0,0.0,False,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127\n')
        i=i+1
